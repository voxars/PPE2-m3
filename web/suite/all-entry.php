...
if($level <= 1)
{
    ...
    <?php
        ...
        while ($donnees = $sel->fetch())
        {
            ...
            echo "<TH>" ?><input type="submit" name="bouton" onclick=window.location.href='http://localhost/M2L-SysResSalles/PPE2-m3/web/suite/facture.php'; class="btn btn-primary" value="Afficher facture"> ."/<TH>";
            echo "</TR>";
        }
    ?>
    </tbody>
